let w, h;
const canvas2 = document.getElementById('fondo-canvas')
...
requestAnimationFrame(function anim(t) {
    if (w !== innerWidth) w = canvas2.width = innerWidth;
    if (h !== innerHeight) h = canvas2.height = innerHeight;
    ctx2.fillStyle = "#000";
    drawCircle(0, 0, w * 10);
    ctx2.fillStyle = ctx2.strokeStyle = "#fff";
    t/=1000
